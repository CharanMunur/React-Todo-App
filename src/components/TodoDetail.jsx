...
const TodoDetail = ({ todo, addSubtask, toggleSubtask, deleteSubtask, onClose }) => {
  ...
  return (
    <motion.aside
      ...
      className="w-[400px] border-l bg-background p-6 flex flex-col overflow-y-auto"
    >
      ...
      <div className="flex items-center gap-4 mb-4 text-sm text-muted-foreground">
        <Badge variant={priorityVariant[todo.priority]}>{todo.priority} Priority</Badge>
        {todo.dueDate && (
